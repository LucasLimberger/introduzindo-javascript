...
const inicio: Page[] = [
    ...
    },
    {
        ...
        contents: [
            ...
            new Paragraph(
                'Fazer isso recebe o nome de <b>"declarar"</b> uma variável.\
            ...
            new Paragraph(
                "Para ver o valor da variável, o <code>console.log()</code> de antes voltou."
            ),
    ...
    },
    {
        ...
        contents: [
            ...
            new Paragraph(
                "Qualquer lugar que aceita um número também aceita uma operação matemática.\
...
const listas: Page[] = [
    {
        ...
        contents: [
            ...
            new Paragraph(
                "Para saber quantas coisas estão numa lista usamos <code>.length</code>:"
            ),
            new CodeBlock(
            ...
            new Paragraph(
                "A palavra <i><b>length</b></i> é inglês para comprimento. Ela também funciona para descobrir o tamanho de uma <i>string</i>."
            ),
            new CodeBlock('console.log("abcdefghijklmnopqrstuvwxyz".length)', "26"),
            new CodeBlock('console.log("".length)', "0"),
            new Paragraph(
                'Do mesmo jeito que listas podem ser vazias, <code>""</code> é uma string vazia.\
    ...
    },
    {
        ...
        contents: [
            ...
            new Paragraph(
                'Enquanto escolhia um número, você pode ter se deparado com o resultado <code>undefined</code>.\
    ...
    },
    {
        ...
        contents: [
            ...
            new Paragraph(
                "<code>.at()</code> acessa elementos da lista assim como o <code>[]</code>.\
...
const tiposConversoes: Page[] = [
    {
        ...
        contents: [
            ...
            new CodeBlock('if (10 < 5) {\n\tconsole.log("Executei!")\n}', ""),
            new Paragraph(
                'O segundo não era para fazer nada mesmo. A palavra <code>if</code> significa "se", em inglês, e usando ela podemos definir código que só é executado às vezes.\
            ...
            new Paragraph(
                "Para checar se os números são iguais, usa-se o símbolo <code>===</code>. Cuide para não confundir com o <code>=</code> que só define variáveis.\
                Já o símbolo <code>!==</code> é o oposto, checa se os números são diferentes."
            ),
            new CodeBlock("console.log(3 === 3)\nconsole.log(3 !== 3)", "true\nfalse"),
            new Paragraph(
                "Há variações dos símbolos <code>></code> e <code><</code> que também permitem que os números sejam iguais:"
            ),
            new CodeBlock(
            ...
            new Paragraph(
                "O <code>if</code> usa {chaves} para definir um <b>bloco de código</b>.\
            ...
            new InputToOutput(
                ...
                "number",
                v => (Number(v) >= 0 ? "positivo ou zero" : "negativo")
            ),
            new Paragraph(
            ...
            new Paragraph(
                "E finalmente, <code>true</code> e <code>false</code> podem ser usados como valores de variável:"
            ),
            new CodeBlock(
    ...
    },
    {
        ...
        contents: [
            ...
            new Paragraph(
                'Em vez de somar os números, a funcionalidade de juntar strings do <code>+</code> que ocorreu.\
            ...
            new Paragraph(
                "De forma mais geral, <code>Number()</code> converte para número, <code>String()</code> para string."
            ),
            new CodeBlock(
            ...
            new Paragraph(
                'O resultado acaba sendo um tal de <code>NaN</code>.\
            ...
            new Paragraph(
                "Outro jeito de converter de número para string é usando <code>.toFixed()</code>:"
            ),
            ...
            new InputToOutput(
                'let realses = @\nconsole.log("R$" + realses.toFixed(2))',
                "number",
    ...
    },
    {
        ...
        contents: [
            ...
            new Paragraph(
                "Além de números e strings, você viu também verdadeiro e falso, esses são do tipo <i>boolean</i>."
            ),
            new CodeBlock(
            ...
            new Paragraph(
                "O tipo de objeto é algo mais abrangente do que só lista.\
    ...
    },
    {
        ...
        contents: [
            ...
            new Paragraph(
                "O jeito principal de converter uma lista para uma string é usando <code>.join()</code>."
            ),
            ...
            new Paragraph(
                "A função <code>String()</code> pode ser usada aqui também.\
            ...
            new Paragraph(
                "Para criar uma lista a partir de uma string, usa-se <code>.split()</code>."
            ),
            new CodeBlock(
            ...
            new Paragraph(
                "É o oposto do <code>.join()</code>: divide a string toda vez que encontrar o separador determinado entre os parênteses."
            ),
            new CodeBlock('console.log("->1->2->3->4".split("->"))', '["", "1", "2", "3", "4"]'),
            new Paragraph(
                'No próximo exemplo, <code>" "</code> é uma string que contém apenas um espaço.'
            ),
            new CodeBlock(
...
const repeticoes: Page[] = [
    {
        ...
        contents: [
            ...
            new CodeBlock(
                "//lembrando que a lista de preços é [24.99, 9.99, 11.99, 69.90, 8.50]\nlet total = 0\nfor (const valor of precos) {\n\ttotal = total + valor\n\tconsole.log(total)\n}",
                "24.99\n34.98\n46.97\n116.87\n125.37"
            ),
            ...
            new Question(
                ["20", "30", "40", "60"],
                2,
                "O resultado começa em 100 e é reduzido por cada item na lista, ou seja, <code>100 - 40 - 10 - 10</code>."
            ),
        ],
    },
    {
        ...
        contents: [
            ...
            new InputToOutput(
                ...
                "text",
                v => (v.length >= 20 ? v : v + "-".repeat(20 - v.length))
            ),
            new Paragraph(
                "É parecido com o <code>if</code> no sentido que o bloco de código é executado quando a condição for verdadeira.\
            ...
            new Paragraph(
                "Cada execução do bloco de código interno é chamada de uma <b>iteração</b>.\
                A condição só é checada no começo de cada iteração, incluindo no começo:"
            ),
            new CodeBlock('while (1 > 2) {\n\tconsole.log("Nunca executa")\n}', ""),
            new Paragraph(
                "Só cuide para não criar um loop infinito, esse código vai fazer o que estiver executando ele travar:"
            ),
            new CodeBlock(
                'while (true) {\n\tconsole.log("Eu sou eterno. Quando eu começar, fuja, porque eu não paro mais.")\n}'
            ),
            new Paragraph(
                "Tanto o <code>for of</code> quanto o <code>while</code> são chamados de <b>estruturas de repetição</b>.\
    ...
    },
    {
        ...
        contents: [
            ...
            new Paragraph(
                "Essa estrutura de repetição é chamada só de <code>for</code>.\
                O nome de variável <code>i</code> é bem comum nesse cenário mas também pode ser alterado."
            ),
            new Paragraph(
                "<code>let i = 0</code> é executado uma vez antes de todo o resto, ciando a variável <code>i</code> que começa em 0."
            ),
            new Paragraph(
                "<code>i++</code> é a mesma coisa do que <code>i = i + 1</code>, acontece no final de cada iteração.\
                O resultado é que <code>i</code> vai subindo de 1 em 1."
            ),
            new Paragraph(
                "<code>i < repetições</code> funciona exatamente como no <code>while</code>:\
            ...
            new Paragraph(
                "O <code>while</code> consegue fazer as mesmas coisas do que o <code>for</code>, porém o código fica mais diseperso.\
            ...
            new Paragraph(
                "Em relação ao <code>for of</code>, o <code>for</code> é mais difícil de usar, mas oferece mais liberdade. Permite modificar o valor inicial:"
            ),
