...
import data, { appName } from "./data.js";
...
function createNavList(topicIndex) {
...
function loadFromLocalStorage() {
    ...
    furthestPage = Math.min(data[furthestTopic].pages.length - 1, Number(localStorage.getItem("furthestPage")));
...
function loadPage(newTopicIndex, newPageIndex) {
    var _a;
    if (loadedePage !== null) {
    ...
    //questão
    const question = ((_a = loadedePage.contents.find(fragment => fragment instanceof Question)) !== null && _a !== void 0 ? _a : null);
    let atFurthestPage = loadedTopicIndex === furthestTopic && loadedPageIndex === furthestPage;
    if (loadedTopicIndex > furthestTopic ||
    ...
    if (isQuestionDone || !atFurthestPage) {
        question === null || question === void 0 ? void 0 : question.markAsSolved();
    }
    //botões de navegação
