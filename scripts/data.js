...
const inicio = [
    ...
    },
    {
        ...
        contents: [
            ...
            new Paragraph('Fazer isso recebe o nome de "declarar" uma variável.\
            ...
            new Paragraph("E para ver o valor da variável, o <code>console.log()</code> de antes voltou."),
    ...
    },
    {
        ...
        contents: [
            ...
            new Paragraph("Operações usam a mesma ordem do que a matemática: multiplicação e divisão acontecem primeiro, depois soma e subtração.\
            ...
            new Question("O que vai aparecer no console quando for executado?", [
                '<code>"Olá, Mundo!"</code>',
                '<code>"Olá,Mundo!"</code>',
                '<code>"Olá, Mundo"</code>',
                '<code>"Olá,Mundo"</code>',
...
const listas = [
    ...
    },
    {
        ...
        contents: [
            ...
            new Paragraph("Enquanto escolhia um núemro, você pode ter se deparado com o resultado <code>undefined</code>.\
    ...
    },
    {
        ...
        contents: [
            ...
            new Paragraph("<code>.at()</code> funciona igual ao <code>[]</code> com números positivos,\
...
const repeticoesCondicoes = [
    {
        ...
        contents: [
            ...
            new Paragraph("O espaço vazio no começo das linhas deixa mais fácil de ver o que está entre as chaves."),
            ...
            new CodeBlock("//lembrando que a lista é [24.99, 9.99, 11.99, 69.90, 8.50]\nlet total = 0\nfor (const valor of precos) {\n\ttotal = total + valor\n\tconsole.log(total)\n}", "24.99\n34.98\n46.97\n116.87\n125.37"),
            ...
            new Question("", ["20", "30", "40", "60"], 2, "O resultado começa em 100 e é reduzido por cada item na lista, ou seja, 100 - 40 - 10 - 10."),
        ],
    },
    {
        subtitle: "Condições",
        contents: [
            new Paragraph("Por enquanto todo o código aqui foi executado 1 ou mais vezes.\
            ...
            new CodeBlock('if (10 < 5) {\n\tconsole.log("Executei!")\n}', ""),
            new Paragraph('O segundo bloco não faz nada mesmo. A palavra <i>"if"</i> significa "se", em inglês, e usando ela o código consegue ir por caminhos diferentes.\
            ...
            new Paragraph("O símbolo <code>===</code> checa se os números são iguais. Cuide para não confundir com o <code>=</code> que define variáveis.\
                Já o símbolo <code>!==</code> é o oposto, checa se os números são diferentes.\
                Eles também funcionam em strings"),
            new CodeBlock('console.log("biscoito" === "bolacha")\nconsole.log("biscoito" === "biscoito")', "false\ntrue"),
            new Paragraph('O <code>if</code> usa {chaves} igual ao <code>for of</code>, para definir um "bloco de código".\
            ...
            new InputToOutput('let numero = @\nif (numero > 0) {\n\tconsole.log("verdadeiro")\n} else {\n\tconsole.log("falso")\n}', "number", v => (Number(v) > 0 ? "verdadeiro" : "falso")),
    ...
    },
    {
        ...
        contents: [
            new Paragraph("Há uma versão um pouco diferente do <code>for of</code>, ela geralmente aparece assim:"),
