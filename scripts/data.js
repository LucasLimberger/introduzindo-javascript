...
const repeticoesCondicoes = [
    ...
    },
    {
        ...
        contents: [
            ...
            new Paragraph("Existem variação dos símbolos <code>></code> e <code><</code> que também permitem que os números sejam iguais:"),
            new CodeBlock("console.log(4 > 4)\nconsole.log(4 >= 4) //maior ou igual", "false\ntrue"),
            new CodeBlock("console.log(3 <= 5) //menor ou igual\nconsole.log(3 <= 3)", "true\ntrue"),
            new Paragraph("<code>===</code> e <code>!==</code> também funcionam com strings:"),
            new CodeBlock('console.log("biscoito" === "bolacha")\nconsole.log("🍪" === "🍪")', "false\ntrue"),
            new Paragraph('O <code>if</code> usa {chaves} igual ao <code>for of</code>, para definir um <b>"bloco de código"</b>.\
